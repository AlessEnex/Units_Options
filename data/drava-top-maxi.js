// data/drava-top-maxi.js
// Contains the specific data for the "Drava Top/Maxi" machine model.

machineData.push({
  modelName: "Drava Top/Maxi",
  statuses: {
    "Capacity": {
      "MT cooling capacity": {
        "Max cooling capacity @-8°C, Pgc=92bar, Tout_GC=36°C": { value: "70 kW" },
      ...
      "Pressures": {
        ...
        "IP": { value: "60" },
        "MT": { value: "52 STD" },
        "BT": { value: "30-36/60 OPT", note: "*Only Dorin" }
      },
    },
    ...
    "oil management": {
      ...
      "oil tank": {
        ...
        "Maximum level sensor": { status: "std" },
      },
      Backpressure: {
    ...
    "HPV-IPV": {
      ...
      "Backup (electronic)": {
        "Backup (electronic)": { status: "opt*",
          note: "Without backup controller. An operator must change the cable manually",
         }
      }
    },
    ...
    "Backup unit": {
      Refrigerant: {
        R134A: {
          status: "opt*",
          note: "*Only available without LT section or heat recovery exchanger, or supplied separated",
        },
        R290: {
          status: "opt*",
          note: "*Only available without LT section or heat recovery exchanger, or supplied separated",
