// data/elba.js
// Contains the specific data for the "Elba" machine model.
  ...
  statuses: {
    "Capacity": {
      "MT cooling capacity": {
        ...
        "Max n° MT compressors (4 cilindri)": { value: "6" },
        "Max n° AUX compressors (4 cilindri)": { value: "3" },
    ...
    "Special configuration": {
      "Parallel compression": {
        "Parallel compression": { status: "std" },
      },
      ...
      "Heat pump + Air conditioned by dedicated compressor": {
        "Heat pump + Air conditioned by dedicated compressor": { status: "opt" },
      },
    },
    frame: {
    ...
    "MT return line": {
      ...
      "Ejectors": {
        ...
        "Vapour ejector": { status: "opt*",
          note: "*Only Danfoss ejector with Danfoss controller or Wurm ejector with Wurm controller",
         },
      },
    },
    "Backup unit": {
