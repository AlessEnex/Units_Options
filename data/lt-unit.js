// data/lt-unit.js
// Contains the specific data for the "LT unit" machine model.
...
machineData.push({
  ...
  statuses: {
    "Capacity": {
      "MT cooling capacity": {
        "Max cooling capacity @-8°C, Pgc=92bar, Tout_GC=36°C": { value: "600 kW" },
      ...
      "LT cooling capacity": {
        "LT cooling capacity": { status: "std" },
    ...
    "Intercooler Section": {
      INTERCOOLER: { INTERCOOLER: { status: "std" } },
      Connections: {
        INOX: { status: "std" },
        K65: { status: "opt" },
      },
    ...
    "HPV-IPV": {
      ...
      "Backup (electronic)": {
        "Backup (electronic)": { status: "opt*",
          note: "*DO NOT replace the mechanical valve. With or without backup controller. Automatically switch from standard functioning to emergency mode.",
         }
      }
    },
